...
[![SLIC image (Source: \[Nowosad 2021\](https://jakubnowosad.com/ogh2021/#10))](https://jakubnowosad.com/ogh2021/figs/slic5.png)](https://jakubnowosad.com/ogh2021/#12)
...
The ROC Curve (Receiver Operating Characteristic Curve) was another helpful way to determine how well the model was predicting outcomes based on the classification thresholds we set in a model (to either maximise recall or precision).

The ROC curve is plotted using the True Positive Rate vs the False Positive Rate. Broadly a value of 0.5 means the model is as good as making a random guess, while a value of 1 is a perfectly accurate model.
