...
![Gdansk NVDI, Source: Landsat 8](Images/gdansk_nvdi_02.png) As before there are some caveats with using this to accurately assert the health of vegetation as more monitoring over time would be needed.

### Texture analysis

Next I wanted to look at potentially extracting more of the built up areas of the city using the [GLCMTextures](https://cran.r-project.org/web/packages/GLCMTextures/vignettes/README.html) library to calculate the more 'jagged' texture of man-made materials like concrete by comparing variance to the adjacent pixels.
