...
Using classification for forecasting into the future can have its pitfalls, there is definitely a risk if the training data provided is not accurate. If the classes we're working with are not easily separable it can be difficult to apply algorithms like SVM.
